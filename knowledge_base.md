# RMIT Adflow — Technical App Breakdown (Updated v0.16.80, Engine v2.16)
...
1. [data/version.txt](file:///g:/My%20Drive/RMIT_WORKS/Apps/Adflow/data/version.txt) — Update the single-line string (e.g. `v0.16.80`).
...
### Severity Guide
- **Patch (Z + 1)**: For bug fixes, UI polish, or algorithm tuning (e.g. `v0.16.79` -> `v0.16.80`).
