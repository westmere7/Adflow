...
const CHANGELOG_DATA = [
  ...
  },
  {
    ...
    date: 'June 2026 — Engine v2.19',
    items: [
      'Clearer Animation Sections: The In Transitions, Continuous Effect, and Frame Transition groups in the Animation panel now read as distinct cards with bolder, accent-marked headings, so they\'re easy to tell apart even with every setting expanded.',
